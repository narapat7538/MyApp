...
import 'package:mini_pro/src/config/room/room_page.dart';
import 'package:mini_pro/src/pages/home/home_page.dart';
import 'package:mini_pro/src/pages/home/homegest_page.dart';
import 'package:mini_pro/src/pages/home/homrpagetoo.dart';
...
class AppRoute{
  ...
  final _route = <String, WidgetBuilder>{
    ...
    homegestRout: (context) => HomegestPages(),
    hometooRout: (context) => HomeToo(),
